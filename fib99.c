...
int fib(int n, int x, int y, int step, RGB bc, RGB fc, int w, int h, RGB *image) 
{
  ...
  /* Ex of how loop works: I already have f3, currently at f4 (thats why I start
  at j = 4) and want to compute f5. The length of the previous word (f3) is 2.
  So I loop 2 times appending each character of f3 to the end of f4 to get f5 */
